...
namespace ProtoMsg {
  ...
  public sealed class BattleUserEquipC2S : pb::IMessage {
    private static readonly pb::MessageParser<BattleUserEquipC2S> _parser = new pb::MessageParser<BattleUserEquipC2S>(() => new BattleUserEquipC2S());
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<BattleUserEquipC2S> Parser { get { return _parser; } }
  ...
  public sealed class BattleUserEquipS2C : pb::IMessage {
    private static readonly pb::MessageParser<BattleUserEquipS2C> _parser = new pb::MessageParser<BattleUserEquipS2C>(() => new BattleUserEquipS2C());
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<BattleUserEquipS2C> Parser { get { return _parser; } }

    /// <summary>Field number for the "Equip" field.</summary>
    public const int EquipFieldNumber = 1;
    private global::ProtoMsg.BattleUserEquipC2S equip_;
    /// <summary>
    ///玩家装备
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::ProtoMsg.BattleUserEquipC2S Equip {
      get { return equip_; }
      set {
        equip_ = value;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (equip_ == null) {
              equip_ = new global::ProtoMsg.BattleUserEquipC2S();
            }
