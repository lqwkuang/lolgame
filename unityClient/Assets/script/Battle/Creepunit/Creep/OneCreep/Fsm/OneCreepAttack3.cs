...
public class OneCreepAttack3 : EntityFSM
{
    private OneCreepFsm creepfsm;
    public OneCreepAttack3(OneCreepFsm fsm)
    {
        this.creepfsm = fsm;
    }
    ...
    {
        base.Enter();
        creepfsm.PlayAnima(Onecreepstate.attack3);
    }

    public override void Exit()
    {
        base.Exit();
        creepfsm.ExitAnima(Onecreepstate.attack3);
    }
